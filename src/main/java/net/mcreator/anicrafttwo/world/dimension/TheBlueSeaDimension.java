...
package net.mcreator.anicrafttwo.world.dimension;
...
public class TheBlueSeaDimension extends AnicrafttwoModElements.ModElement {
	public TheBlueSeaDimension(AnicrafttwoModElements instance) {
		super(instance, 24);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("anicrafttwo:the_blue_sea"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
