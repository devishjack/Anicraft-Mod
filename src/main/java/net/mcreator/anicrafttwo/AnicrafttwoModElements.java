...
public class AnicrafttwoModElements {
	...
	public AnicrafttwoModElements() {
		sounds.put(new ResourceLocation("anicrafttwo", "luffy-arm-stretch"),
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == AnicrafttwoModElements.ModElement.class)
						elements.add((AnicrafttwoModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(AnicrafttwoModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new AnicrafttwoModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		AnicrafttwoMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final AnicrafttwoModElements elements;
		protected final int sortid;
		public ModElement(AnicrafttwoModElements elements, int sortid) {
