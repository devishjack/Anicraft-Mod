package net.mcreator.anicrafttwo.entity.renderer;
...
import net.mcreator.anicrafttwo.entity.EiichiroOdaEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class EiichiroOdaRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EiichiroOdaEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsteve(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("anicrafttwo:textures/eiichirooda.png");
					}
				};
			});
		}
